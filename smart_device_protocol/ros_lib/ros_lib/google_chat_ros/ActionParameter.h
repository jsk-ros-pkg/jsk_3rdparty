#ifndef _ROS_google_chat_ros_ActionParameter_h
#define _ROS_google_chat_ros_ActionParameter_h
...
namespace google_chat_ros
{
  ...
  class ActionParameter : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "google_chat_ros/ActionParameter"; };
