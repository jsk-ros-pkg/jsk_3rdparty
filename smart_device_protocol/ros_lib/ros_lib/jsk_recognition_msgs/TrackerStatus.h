...
namespace jsk_recognition_msgs
{
  ...
  class TrackerStatus : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "jsk_recognition_msgs/TrackerStatus"; };
    virtual const char * getMD5() override { return "78e8f06a6b728df052dd181bfcf6c26e"; };
