...
namespace jsk_recognition_msgs
{
  ...
  class BoundingBoxArrayWithCameraInfo : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "jsk_recognition_msgs/BoundingBoxArrayWithCameraInfo"; };
    virtual const char * getMD5() override { return "e68d75609bb0b7f4ac5831524b0126e7"; };
