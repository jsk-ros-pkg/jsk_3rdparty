...
namespace jsk_recognition_msgs
{
  ...
  class ImageDifferenceValue : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "jsk_recognition_msgs/ImageDifferenceValue"; };
    virtual const char * getMD5() override { return "80b6f355db87c1b2d8b04d2f620fe0a7"; };
