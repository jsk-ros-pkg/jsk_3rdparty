...
namespace jsk_recognition_msgs
{
  ...
  class PosedCameraInfo : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "jsk_recognition_msgs/PosedCameraInfo"; };
    virtual const char * getMD5() override { return "bfcbc4847adb445a428e4af537ed849a"; };
