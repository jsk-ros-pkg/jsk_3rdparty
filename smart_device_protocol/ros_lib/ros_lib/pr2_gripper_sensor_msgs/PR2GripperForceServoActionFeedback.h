...
namespace pr2_gripper_sensor_msgs
{
  ...
  class PR2GripperForceServoActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "pr2_gripper_sensor_msgs/PR2GripperForceServoActionFeedback"; };
    virtual const char * getMD5() override { return "d8ca0d3860c2a6ed1145d230fe6bd9db"; };
