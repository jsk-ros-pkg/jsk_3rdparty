...
namespace pr2_gripper_sensor_msgs
{
  ...
  class PR2GripperFindContactActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "pr2_gripper_sensor_msgs/PR2GripperFindContactActionFeedback"; };
    virtual const char * getMD5() override { return "6f5508091ee61f963690fb74fc7df932"; };
