...
namespace pr2_gripper_sensor_msgs
{
  ...
  class PR2GripperFindContactActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "pr2_gripper_sensor_msgs/PR2GripperFindContactActionGoal"; };
    virtual const char * getMD5() override { return "50fc3f7e604d4e257a2e38e3aa3f204e"; };
