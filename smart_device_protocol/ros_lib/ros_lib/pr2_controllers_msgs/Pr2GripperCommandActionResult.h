...
namespace pr2_controllers_msgs
{
  ...
  class Pr2GripperCommandActionResult : public ros::Msg
  {
    public:
      ...
      _status_type status;
      typedef pr2_controllers_msgs::Pr2GripperCommandResult _result_type;
      _result_type result;
    ...
    virtual const char * getType() override { return "pr2_controllers_msgs/Pr2GripperCommandActionResult"; };
