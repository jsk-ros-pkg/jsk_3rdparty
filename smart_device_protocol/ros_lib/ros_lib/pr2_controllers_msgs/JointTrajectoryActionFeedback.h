...
namespace pr2_controllers_msgs
{
  ...
  class JointTrajectoryActionFeedback : public ros::Msg
  {
    public:
      ...
      _status_type status;
      typedef pr2_controllers_msgs::JointTrajectoryFeedback _feedback_type;
    ...
    virtual const char * getType() override { return "pr2_controllers_msgs/JointTrajectoryActionFeedback"; };
