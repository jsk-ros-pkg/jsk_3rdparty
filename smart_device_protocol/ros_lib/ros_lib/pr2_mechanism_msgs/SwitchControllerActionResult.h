...
namespace pr2_mechanism_msgs
{
  ...
  class SwitchControllerActionResult : public ros::Msg
  {
    public:
      ...
      _status_type status;
      typedef pr2_mechanism_msgs::SwitchControllerResult _result_type;
      _result_type result;
    ...
    virtual const char * getType() override { return "pr2_mechanism_msgs/SwitchControllerActionResult"; };
