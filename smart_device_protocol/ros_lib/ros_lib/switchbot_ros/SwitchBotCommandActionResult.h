#ifndef _ROS_switchbot_ros_SwitchBotCommandActionResult_h
...
#include "switchbot_ros/SwitchBotCommandResult.h"

namespace switchbot_ros
{

  class SwitchBotCommandActionResult : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "switchbot_ros/SwitchBotCommandActionResult"; };
