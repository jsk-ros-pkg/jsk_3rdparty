...
namespace naoqi_bridge_msgs
{
  ...
  class SetSpeechVocabularyActionResult : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "naoqi_bridge_msgs/SetSpeechVocabularyActionResult"; };
    virtual const char * getMD5() override { return "0698ce25b2d595b82357c010557e935f"; };
