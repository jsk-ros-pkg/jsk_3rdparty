...
namespace naoqi_bridge_msgs
{
  ...
  class BlinkActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "naoqi_bridge_msgs/BlinkActionFeedback"; };
    virtual const char * getMD5() override { return "b4761017d2f70a859c914a9306034255"; };
