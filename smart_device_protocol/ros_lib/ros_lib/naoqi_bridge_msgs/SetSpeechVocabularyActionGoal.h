...
namespace naoqi_bridge_msgs
{
  ...
  class SetSpeechVocabularyActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "naoqi_bridge_msgs/SetSpeechVocabularyActionGoal"; };
    virtual const char * getMD5() override { return "f93300199bb500a3e511fde0b0394ddb"; };
