...
namespace naoqi_bridge_msgs
{
  ...
  class RunBehaviorAction : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "naoqi_bridge_msgs/RunBehaviorAction"; };
    virtual const char * getMD5() override { return "a6a26afb8ff0902c5587c8bfbdc46892"; };
