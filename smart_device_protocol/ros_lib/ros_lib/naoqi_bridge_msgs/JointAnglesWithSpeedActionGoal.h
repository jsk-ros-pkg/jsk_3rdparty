...
namespace naoqi_bridge_msgs
{
  ...
  class JointAnglesWithSpeedActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "naoqi_bridge_msgs/JointAnglesWithSpeedActionGoal"; };
    virtual const char * getMD5() override { return "9b722e9749aa53fc0e8ca7aa12e95efb"; };
