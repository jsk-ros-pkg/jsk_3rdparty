...
namespace jsk_footstep_controller
{
  ...
  class GoPosGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "jsk_footstep_controller/GoPosGoal"; };
    virtual const char * getMD5() override { return "69d55867d9a94dddd5bc8dc8910558cf"; };
