...
namespace jsk_footstep_controller
{
  ...
  class GoPosActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "jsk_footstep_controller/GoPosActionFeedback"; };
    virtual const char * getMD5() override { return "f94482fa4ac6ec4eba7904ad5f096d59"; };
